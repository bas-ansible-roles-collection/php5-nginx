...
available [here](https://semaphoreci.com/bas-ansible-roles-collection/system-core).
...
| -------------------------------- | ----------------- | -------------------------------------- | --------------------------- |
| barc-php5-nginx-test-ubuntu-bare | *computed value*  | `barc-php5-nginx-test-ubuntu-bare.v.m` | The VM's private IP address |
| barc-php5-nginx-test-centos-bare | *computed value*  | `barc-php5-nginx-test-centos-bare.v.m` | The VM's private IP address |
